...
clean: clean-build-log
	...
	@rm -rf .submodules .circuitpy-deps .micropython-deps .devdeps .build build
...
build/feather_m4_express.uf2: clean-build-log lint circuitpy-deps circuitpy-freeze-kmk-atmel-samd micropython-build-unix
else
build/feather_m4_express.uf2: clean-build-log lint circuitpy-deps circuitpy-freeze-kmk-atmel-samd
endif
...
build-feather_m4_express: build/feather_m4_express.uf2
